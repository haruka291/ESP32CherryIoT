...
//
  ...
  ledcWriteTone(spkrPin, MI); delay(350);
  ledcWriteTone(spkrPin, 0);  delay(50);
  ledcWriteTone(spkrPin, RE); delay(350);
  ledcWriteTone(spkrPin, 0);  delay(50);

  
  ledcWriteTone(spkrPin, DO); delay(350);
  ledcWriteTone(spkrPin, 0);  delay(50);
  ledcWriteTone(spkrPin, DO); delay(350);
  ledcWriteTone(spkrPin, 0);  delay(50);
  ledcWriteTone(spkrPin, RE); delay(350);
  ...
  ledcWriteTone(spkrPin, MI); delay(500); 
  ledcWriteTone(spkrPin, 0);  delay(50);
  ledcWriteTone(spkrPin, RE); delay(200); 
  ledcWriteTone(spkrPin, 0);  delay(50);
  ledcWriteTone(spkrPin, RE); delay(750); 
  ledcWriteTone(spkrPin, 0);  delay(400);
  }
